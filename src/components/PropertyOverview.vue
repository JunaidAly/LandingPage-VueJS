    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-14">
      ...
      <div class="flex flex-col gap-1">
        ...
        <p class="text-white font-light font-inter text-sm leading-relaxed">
          For the first time in its distinguished architectural legacy, Binghatti Developers departs from the Dubai skyline to create a ground-level masterpiece. Binghatti Tilal is more than just a residential project; it is a master-planned sanctuary designed for those who seek the privacy of a villa with the bold, avant-garde design language Binghatti is world-renowned for.
        </p>
        <p class="text-white font-light font-inter text-sm leading-relaxed">
          With a starting price of AED 3.2 Million, Binghatti Tilal offers an entry point into ultra-luxury living that is strategically positioned just 18 minutes from the Burj Khalifa.
        </p>
      </div>
      ...
      <div class="flex flex-col gap-1">
        ...
        <p class="text-white font-light font-inter text-sm leading-relaxed">
          When analyzing the Dubai real estate market, Binghatti Tilal stands out for several key financial reasons:
        </p>
      ...
      <div class="flex flex-col gap-1">
        ...
        <p class="text-white font-light font-inter text-sm leading-relaxed ">
          Final payment plan details are currently being finalized. Register below to receive the official PDF brochure and payment schedule directly to your inbox.
        </p>
      </div>
